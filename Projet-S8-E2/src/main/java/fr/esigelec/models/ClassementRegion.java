...
public class ClassementRegion implements IClassement{
	...
	public ClassementRegion(Region reg,int lic,int licF,int licH) {
		this.licences = lic;
		this.region = reg;
	...
	public ClassementRegion(int licences, int licencesFemmes, int licencesHommes, int licencesHommes114,
			...
			int licencesTotales8099, Region region) {

...
<body>
			...
			<div class="card-body">
				<form method="post">
					...
					<div
						...
						<a href="${pageContext.request.contextPath}/index" class="btn btn-primary-custom">Annuler</a>
	...
	<div class="container py-4">
		...
		<div class="text-center mt-4">
			<a href="${pageContext.request.contextPath}/indexMembre" class="text-decoration-none"

                        ...
                        <form method="post" action="login">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="loginEmail" name="loginEmail" placeholder="nom@exemple.com" required>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-4">
                                <p class="mb-0">Vous n'avez pas de compte? <a href="${pageContext.request.contextPath}/inscription" class="text-danger">Inscrivez-vous</a></p>
                            </div>
                        </form>
                    </div>
                </div>
